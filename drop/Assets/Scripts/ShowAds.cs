    ...
    public class ShowAds : MonoBehaviour
    {
        ...
        async void Start()
        {
            ...
            if (PlayerPrefs.GetInt("GamesSinceLastAdPop", 0) >= 2 && PlayerPrefs.GetInt("GameSinceLastAd", 0) >= 7)
            {
                ...
                PlayerPrefs.SetInt("PointsSinceLastAdPop", 0);
